...
const int armlowpost   = 584;
const int wristlowpost = 642;

const int armcubeload   = 190;
const int wristcubeload = 540;
...
task autonomous()
{
	...
	if (SensorValue[RedOrBlue] == 0) //blue
	{
		...
		{
			//backup
			moverobot(0,0,-760,0,1,lowspd+40);
			wait1Msec (10);
			//armup
			movearm(lowspd+15,0,1,512);
			wait1Msec (10);
			//wrist down
			...
			wait1Msec (10);
			//go to middle post
			movewrist (highspd,0,1,670);
			movearm(medspd,0,1,armlowpost);
			movewrist (highspd,0,1,400);
			movearm(medspd,0,1,armmiddlepost);
			movewrist (highspd,0,1,wristmiddlepost);
			wait1Msec (10);
			//turn right
			turnrobot(10,1,lowspd+20);
			wait1Msec (10);
			//forwodrd
			moverobot(0,0,150,0,1,highspd);
			wait1Msec (10);
			//wrist down
			movewrist (highspd,0,1,1000);
			wait1Msec (10);
			...
			wait1Msec (10);
			//go right
			moverobot(2350,0,0,0,1,highspd);
			wait1Msec (10);
			//backup
			...
			// go to qube load hight
			movewrist (highspd,0,1,wristcubeload);
			movearm(lowspd,0,1,armcubeload+20);
			wait1Msec (10);
			//forword
			moverobot(0,0,380,0,1,highspd);
			wait1Msec (10);
		...
		if (SensorValue[SkyOrNot] == 1)//blue skyrise auton
		{
			...
			//rotte left
			turnrobot(40,0,highspd);
			wait1Msec (10);
			//right
			moverobot(3300,0,0,0,1,highspd);
			wait1Msec (10);
			//backup
			moverobot(0,0,-1823.5,0,1,highspd);
			wait1Msec (10);
			//forwords
			moverobot(0,0,50,0,1,highspd);
			wait1Msec (10);
			////rotte right
			//turnrobot(20,1,highspd);
			//wait1Msec (10);
			//left
	...
	if (SensorValue[RedOrBlue] == 1)//red
	{
		...
		if (SensorValue[SkyOrNot] == 1)//red skyrise auton
		{
			...
			wait1Msec (10);
			//rotte left
			turnrobot(5,0,highspd);
			wait1Msec (10);
			//right
			moverobot(3500,0,0,0,1,highspd);
			wait1Msec (10);
			//left
			moverobot(130,1,0,0,1,highspd);
			wait1Msec (10);
			// go to qube load hight
			movewrist (highspd,0,1,wristcubeload);
			movearm(lowspd,0,1,armcubeload+20);
