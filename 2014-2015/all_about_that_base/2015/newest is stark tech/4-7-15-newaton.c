...
task autonomous()
{
	...
	if (SensorValue[RedOrBlue] == 1)//red
	{
		...
		{
			//backup
			moverobot(11200,0,0,0,1,highspd);
	...
	if (SensorValue[RedOrBlue] == 0) //blue
	{
		...
		{
			//backup
			moverobot(0,0,-850,0,1,lowspd+40);
			wait1Msec (10);
			//armup
			movearm(lowspd+35,0,1,512);
			wait1Msec (10);
			//wrist down
			...
			wait1Msec (10);
			//turn right
			turnrobot(15,1,lowspd+20);
			wait1Msec (10);
			//forwodrd
			moverobot(0,0,160,0,1,highspd);
			wait1Msec (10);
			//wrist down
			movewrist (highspd,0,1,1000);
			wait1Msec (10);
			...
			wait1Msec (10);
			//go right
			moverobot(2500,0,0,0,1,highspd);
			wait1Msec (10);
			//backup
			moverobot(0,0,-450,0,1,highspd);
			wait1Msec (10);
			// go to qube load hight
			movewrist (highspd,0,1,wristcubeload);
			movearm(medspd,0,1,armcubeload);
			wait1Msec (10);
			//forword
