...
#pragma config(Sensor, I2C_2,  RightShootE,    sensorNone)
...
#pragma config(Motor,  port7,           RightShootT,   tmotorVex393_MC29, openLoop, driveRight, encoderPort, I2C_1)
...
const int medspd    = 95;
const int lowspd     = 40;
int smOF = 1, sSpeed = 95, iSpeed = highspd, minRPM = 70;
...
motor[LeftShootB] = sSpeed;
motor[LeftShootT] = sSpeed;
motor[RightShootB] = sSpeed;
motor[RightShootT] = sSpeed;
		}
}
