...
#pragma config(Motor,  port4,           LeftShootF,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           LeftShootB,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           RightShootF,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           RightShootB,   tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
	...
	//call robot movement function
		...
		motor[RightShootF] = Y2;
		motor[RightShootB] = Y2;
	}
}
