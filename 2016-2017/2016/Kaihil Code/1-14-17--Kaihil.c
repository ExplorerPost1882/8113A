...
#pragma config(Motor,  port10,          pincerL,       tmotorVex393_HBridge, openLoop, driveLeft)
...
task autonomous()
{
	startTask(lcdAndArm);
		...
		motor[pincerR]=0;
		wait1Msec(100);
		//opens claw to ensure stars are kncked off
		...
		motor[pincerR]=0;
		wait1Msec(95);
		//closes claw to knock lower stars
		...
		motor[backRight]=0;
		wait1Msec(50);
		//goes forward to knock off fence
		...
		motor[pincerR]=0;
		wait1Msec(105);
		//opens claw straighten them out
