...
#pragma config(Motor,  port1,           vClawL,        tmotorVex393_HBridge, openLoop, driveLeft)
...
#pragma config(Motor,  port10,          vClawR,        tmotorVex393_HBridge, openLoop, reversed)
