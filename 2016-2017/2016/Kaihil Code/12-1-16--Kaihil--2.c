...
#pragma config(Motor,  port2,           vClawL,        tmotorVex393_MC29, openLoop, driveRight, encoderPort, I2C_2)
...
#pragma config(Motor,  port9,           vClawR,        tmotorVex393_MC29, openLoop, driveLeft, encoderPort, I2C_4)
