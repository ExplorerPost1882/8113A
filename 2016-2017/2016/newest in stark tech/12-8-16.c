...
#pragma config(Motor,  port1,           pincer,        tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_5)
...
#include "12-6-16 includes.c"				 //main user code has all the voids...no need to modify.
...
task usercontrol()
{
	...
	while (true)
	{
		...
		//pincer
		Pi1 = (abs(vexRT[Ch2Xmtr2]) > threshold+10) ? (vexRT[Ch2Xmtr2]*2/3) : (0);
