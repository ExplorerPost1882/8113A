...
#pragma config(Motor,  port4,           LeftShoot,     tmotorVex393_MC29, openLoop, reversed, driveLeft, encoderPort, I2C_1)
#pragma config(Motor,  port6,           RightShoot,    tmotorVex393_MC29, openLoop, driveRight, encoderPort, I2C_2)
