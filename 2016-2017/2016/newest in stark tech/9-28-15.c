...
#pragma config(Motor,  port4,           LeftShootB,    tmotorVex393_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port5,           LeftShootT,    tmotorVex393_MC29, openLoop, driveLeft, encoderPort, I2C_2)
